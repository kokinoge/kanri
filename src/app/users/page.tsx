              ...
              <tr key={user.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <select
                    ...
                    disabled={!canManageUser(session, user.role as Role) || (user.role === 'admin' && session?.user?.role !== 'admin')}
                  >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                   <button
                    ...
                    disabled={!canManageUser(session, user.role as Role)}
...
const UsersPage = dynamic(() => Promise.resolve(UsersPageInner), {
  ssr: false,
  loading: () => (
