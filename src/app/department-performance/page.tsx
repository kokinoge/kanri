      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-2">
            <ImportExportActions
              exportEndpoint="/api/department-performance"
              importEndpoint="/api/import-export/department-performance"
              dataType="事業部パフォーマンス"
              filePrefix="department-performance"
              filters={{
